...
ACSL implementace predikátu pro spodní řez haldy pomocí potomka je velmi podobná vrchnímu řezu haldy pomocí potomka. Pokrývá ale vrcholy haldy s indexem větším než problematický vrchol a jejich rodičovské vrcholy. Nemusí platit, že graf spodního řezu haldy na konci vykonávání obsahuje celou původní haldu. Tato situace by nastala pouze v případě, že byl problematický vrchol probublán až do kořene haldy.
